...
public class FlowLayouts extends ViewGroup {
    ...
    public FlowLayouts(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.FlowLayouts);
        lineSpacing = mTypedArray.getDimensionPixelSize(R.styleable.FlowLayouts_lineSpacing, 0);
        mTypedArray.recycle();
    }
