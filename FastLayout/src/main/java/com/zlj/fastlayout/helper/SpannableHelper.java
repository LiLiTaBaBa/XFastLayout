...
public final class SpannableHelper {
     ...
     *             </ul>
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * 设置前景色(字体颜色)
     */
    public SpannableHelper setForegroundColor(@ColorInt final int color) {
     ...
     * 设置背景色
     */
    public SpannableHelper setBackgroundColor(@ColorInt final int color) {
     ...
     * 设置行高
     */
    public SpannableHelper setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * 设置引用线的颜色
     */
    public SpannableHelper setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setBullet(@ColorInt final int color,
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setFontProportion(final float proportion) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setFontXProportion(final float proportion) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setStrikethrough() {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setUnderline() {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setSuperscript() {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setSubscript() {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setBold() {
        isBold = true;
        return this;
    }
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                             final Blur style) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final float dx,
                               final float dy,
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SpannableHelper} instance
     */
    public SpannableHelper appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            }
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(getResources(), b);
