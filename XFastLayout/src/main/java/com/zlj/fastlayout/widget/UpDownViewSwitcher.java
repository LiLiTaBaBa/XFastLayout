...
public class UpDownViewSwitcher extends ViewSwitcher {
        ...
        if(adapter!=null){
            ...
            super.setFactory(new ViewFactory() {
                ...
                public View makeView() {
                    return  View.inflate(getContext(),adapter.getLayoutId(),null);
                }
            });
            switchToNextView();
            startAutoPlay();
    ...
    public abstract static  class Adapter<T>{
        List<T> data;
        int layoutId;
        public Adapter(int layoutId,List<T> list){
            this.data=list;
        ...
        public abstract void convert(View contentView,T item);
    ...
    public void switchToNextView(){
        ...
        if(adapter!=null){
            adapter.convert(getNextView(),adapter.getData().get(index%adapter.getData().size()));
        }
        this.showNext();
        index++;
    }
